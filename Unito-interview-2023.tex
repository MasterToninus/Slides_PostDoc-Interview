...
{	
	{\vskip 1ex}
	UniTo Interview, February 25, 2023
}
...
%-------------------------------------------------------------------------------------------------------------------------------------------------
\begin{frame}[t]
\frametitle{Academic Resume}
\begin{center}
	\begin{tikzpicture}
		\draw[line width=2mm,-latex,UniGreen!20] (-0.2,0) -- (9,0);
		\foreach \X [evaluate=\X as \Y using int(\X-2017),count=\Z] in {2017,2019,2021,2022}
		{
...
\begin{itemize}
\item<1-> 4-years Phd in the \textbf{International doctoral programme in Science} (double degree)
\begin{itemize}
	\item<1-> ~ 2 years at \textbf{Università Cattolica del Sacro Cuore}, Brescia, Italy;
	\item<2-> ~ 2 years at \textbf{KU Leuven}, Belgium.
\end{itemize}
\item<3-> 1-year postdoctoral fellowship at the \textbf{Max Planck institute for Mathematics}, Bonn, Germany.
\item<4-> 1-year postdoctoral fellowship at \textbf{Università Cattolica del Sacro Cuore}, Brescia, Italy.
\end{itemize}

\vfill
\onslide<5->{
	\begin{probox}[colbacktitle=yellow!15!white ,colback=yellow!15!white]{ Research interests}
		\begin{itemize}
			\item[\smark] Differential and symplectic geometry, \qquad \emph{(symmetries and reductions)}
			\item[\smark] Higher categories, \qquad\emph{(higher symplectic geometry, algebras up to homotopies)}
			\item[\smark] Mathematical physics, \qquad\emph{(Lagrangian field theories)}.
		\end{itemize}
	\end{probox}		
}
\end{frame}
...
%-------------------------------------------------------------------------------------------------------------------------------------------------
	\begin{frame}[shrink]{Selected Results}
		...
		\begin{columns}
			...
			\begin{column}[T]{0.8\textwidth}
				\begin{itemize}
					\item[-] Explicit \emph{Homotopy comomentum map} coming from hydrodynamics \small( ideal fluid configurations as Lie algebra action)
					\item[-] Relations with \emph{knot theory} \small (hydrodinamics interpretation: links as concentrated vortices).
				\end{itemize}
			\end{column}		
		\end{columns}	
		...
		\begin{columns}[T]
			\begin{column}{0.2\textwidth}
				\centering
				\onslide<3->{
					\fbox{\includegraphics[width=.9\textwidth]{./Pictures/cover-Selecta-honest}}
				}
			\end{column}		
			\begin{column}{0.8\textwidth}
				\begin{itemize}
		...
		\begin{columns}[T]
			\begin{column}{0.2\textwidth}
				\centering
				\onslide<4->{
					\fbox{\includegraphics[width=.9\textwidth]{./Pictures/cover-PJM-honest}}
				}
			\end{column}		
			\begin{column}{0.8\textwidth}
				\begin{itemize}
					\item<4->[-] A purely algebraic reduction scheme for multisymplectic manifolds w.r.t. possibly singular constraints sets.
					\item<4->[-] Implying a new reduction scheme on symplectic manifolds. 
				\end{itemize}	
			\end{column}		
		\end{columns}
...
%-------------------------------------------------------------------------------------------------------------------------------------------------
\section{Possible Interactions at UniTO}
\checkpoint
%-------------------------------------------------------------------------------------------------------------------------------------------------
	\begin{frame}[fragile]{Possible interactions at UniTO}
		An interdisciplinary research project encompassing algebra, geometry and mathematical physics.
		\vfill
		\center
		\pause
		...
		\begin{columns}
			...
			\begin{column}{0.45\linewidth}
				\textbf{Group:} Mathematical physics;
				\\
				\textbf{Project:} \href{https://www.dipmatematica.unito.it/do/progetti.pl/Show?_id=haax}{Geometric methods in mathematical Physics};
				\\
				\textbf{Coordinator:} \href{https://www.dipmatematica.unito.it/do/docenti.pl/Show?_id=maferrar#tab-didattica}{Prof. Marco Ferraris}
				\\
				\emph{"formalismo lagrangiano e formalismo hamiltoniano nel calcolo delle variazioni di ordine superiore su varietà fibrate"}
			\end{column}	
			%
			\pause
			\hfill
			\begin{column}{0.45\linewidth}
				\textbf{Group:} Mathematical physics;
				\\
				\textbf{Project:} \href{https://www.dipmatematica.unito.it/do/progetti.pl/Show?_id=haax}{Algebraic and Geometric structures in mathematical physics};
				\\
				\textbf{Coordinator:} \href{https://www.dipmatematica.unito.it/do/docenti.pl/Show?_id=mpalese#tab-profilo}{Prof. Marcella Palese}
				\\
				\emph{"studio della relazione tra simmetrie, leggi di conservazione e soluzioni in sistemi nonlineari, (...) applicazioni della geometria differenziale"}
			\end{column}	
			\hfill
			%
		\end{columns}
